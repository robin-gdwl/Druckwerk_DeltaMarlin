...
#define CUSTOM_MACHINE_NAME "SKR3-DELTA_DRUCKWERK_XYZ"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define PROBE_MANUALLY_STEP 0.25      // (mm)
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 150   // (mm)

  // Maximum reachable area
  #define DELTA_MAX_RADIUS       160    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 345        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 632.4            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 210.3              // (mm) Get this value from G33 auto calibrate
...
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. TODO
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 380*2.2 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 3600, 3600, 3600, 3600 }
...
#define Z_CLEARANCE_BETWEEN_PROBES  35 // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     35 // Z Clearance between multiple probes
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_RAISE_MIN  7.5   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 100   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE   7.5   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 1000 // (minutes) EEPROM save interval during print
#endif
...
//TODO: check why this fails the build 
#define SPEAKER  
